...
export const ITEMS: Record<string, ItemDef> = {
  ...
  wooden_shield: { id: 'wooden_shield', name: 'Bouclier en bois', icon: '🛡️', rarity: 'common', slot: 'armor', def: 4, hp: 15, classes: ['warrior'], value: 12, desc: 'Un couvercle de tonneau reconverti.', element: 'earth', maxDurability: 1000, reqLevel: 1 },
  hide_tunic: { id: 'hide_tunic', name: 'Tunique de peau', icon: '🧥', rarity: 'common', slot: 'armor', def: 4, hp: 15, classes: ['archer'], value: 12, desc: 'Taillée dans une peau de loup tannée.', element: 'earth', maxDurability: 1000, reqLevel: 1 },
  ...
  iron_mail: { id: 'iron_mail', name: 'Cotte de fer', icon: '🛡️', rarity: 'uncommon', slot: 'armor', def: 6, hp: 20, classes: ['warrior'], value: 70, desc: 'Protection solide.', element: 'neutral', maxDurability: 1000, reqLevel: 5 },
  iron_vest: { id: 'iron_vest', name: 'Brigandine de fer', icon: '🧥', rarity: 'uncommon', slot: 'armor', def: 6, hp: 20, classes: ['archer'], value: 70, desc: 'Protection solide.', element: 'neutral', maxDurability: 1000, reqLevel: 5 },
  ...
  frost_plate: { id: 'frost_plate', name: 'Plastron de givre', icon: '🥶', rarity: 'rare', slot: 'armor', def: 11, hp: 45, classes: ['warrior'], value: 260, desc: 'Repousse le froid mortel.', element: 'frost', maxDurability: 1000, setId: 'frost_set', reqLevel: 10 },
  frost_leather: { id: 'frost_leather', name: 'Veste givrée', icon: '🥶', rarity: 'rare', slot: 'armor', def: 11, hp: 45, classes: ['archer'], value: 260, desc: 'Repousse le froid mortel.', element: 'frost', maxDurability: 1000, setId: 'frost_set', reqLevel: 10 },
  frost_robe: { id: 'frost_robe', name: 'Manteau givré', icon: '🥻', rarity: 'rare', slot: 'armor', def: 11, hp: 45, classes: ['mage', 'healer'], value: 260, desc: 'Repousse le froid mortel.', element: 'frost', maxDurability: 1000, setId: 'frost_set', reqLevel: 10 },
  wind_cloak: { id: 'wind_cloak', name: 'Cape des vents', icon: '🌪️', rarity: 'rare', slot: 'armor', def: 9, hp: 35, classes: ['warrior'], value: 220, desc: 'Allège son porteur.', element: 'wind', maxDurability: 1000, setId: 'wind_set', reqLevel: 10 },
  wind_leather: { id: 'wind_leather', name: 'Gilet du Bourrasque', icon: '🌪️', rarity: 'rare', slot: 'armor', def: 9, hp: 35, classes: ['archer'], value: 220, desc: 'Allège son porteur.', element: 'wind', maxDurability: 1000, setId: 'wind_set', reqLevel: 10 },
  wind_robe: { id: 'wind_robe', name: 'Voile des vents', icon: '🥻', rarity: 'rare', slot: 'armor', def: 9, hp: 35, classes: ['mage', 'healer'], value: 220, desc: 'Allège son porteur.', element: 'wind', maxDurability: 1000, setId: 'wind_set', reqLevel: 10 },
  scale_mail: { id: 'scale_mail', name: 'Cotte d\'écailles', icon: '🧜', rarity: 'rare', slot: 'armor', def: 10, hp: 40, classes: ['warrior'], value: 250, desc: 'Écailles miroitantes.', element: 'water', maxDurability: 1000, setId: 'water_set', reqLevel: 10 },
  water_leather: { id: 'water_leather', name: 'Harnais des Marées', icon: '🧜', rarity: 'rare', slot: 'armor', def: 10, hp: 40, classes: ['archer'], value: 250, desc: 'Écailles miroitantes.', element: 'water', maxDurability: 1000, setId: 'water_set', reqLevel: 10 },
  water_robe: { id: 'water_robe', name: 'Tunique océane', icon: '🥻', rarity: 'rare', slot: 'armor', def: 10, hp: 40, classes: ['mage', 'healer'], value: 250, desc: 'Écailles miroitantes.', element: 'water', maxDurability: 1000, setId: 'water_set', reqLevel: 10 },
  ...
  ember_chest: { id: 'ember_chest', name: 'Cuirasse ardente', icon: '🌋', rarity: 'epic', slot: 'armor', def: 18, hp: 90, classes: ['warrior'], value: 500, desc: 'Brûle ceux qui la touchent.', element: 'fire', maxDurability: 1000, setId: 'fire_set', reqLevel: 15 },
  ember_leather: { id: 'ember_leather', name: 'Brigandine ardente', icon: '🌋', rarity: 'epic', slot: 'armor', def: 18, hp: 90, classes: ['archer'], value: 500, desc: 'Brûle ceux qui la touchent.', element: 'fire', maxDurability: 1000, setId: 'fire_set', reqLevel: 15 },
  ember_robe: { id: 'ember_robe', name: 'Étole incandescente', icon: '🥻', rarity: 'epic', slot: 'armor', def: 18, hp: 90, classes: ['mage', 'healer'], value: 500, desc: 'Brûle ceux qui la touchent.', element: 'fire', maxDurability: 1000, setId: 'fire_set', reqLevel: 15 },
  earth_plate: { id: 'earth_plate', name: 'Armure de terre', icon: '⛰️', rarity: 'epic', slot: 'armor', def: 20, hp: 80, classes: ['warrior'], value: 600, desc: 'Aussi dure que la roche.', element: 'earth', maxDurability: 1000, setId: 'earth_set', reqLevel: 15 },
  earth_leather: { id: 'earth_leather', name: 'Cotte de Pierre', icon: '⛰️', rarity: 'epic', slot: 'armor', def: 20, hp: 80, classes: ['archer'], value: 600, desc: 'Aussi dure que la roche.', element: 'earth', maxDurability: 1000, setId: 'earth_set', reqLevel: 15 },
  earth_robe: { id: 'earth_robe', name: 'Toge tellurique', icon: '🥻', rarity: 'epic', slot: 'armor', def: 20, hp: 80, classes: ['mage', 'healer'], value: 600, desc: 'Aussi dure que la roche.', element: 'earth', maxDurability: 1000, setId: 'earth_set', reqLevel: 15 },
  templar_armor: { id: 'templar_armor', name: 'Armure de Templier', icon: '🛡️', rarity: 'epic', slot: 'armor', def: 18, hp: 90, classes: ['warrior'], value: 800, desc: 'Bénie par les prêtres.', element: 'light', maxDurability: 1000, setId: 'light_set', reqLevel: 15 },
  light_leather: { id: 'light_leather', name: 'Justaucorps Doré', icon: '🛡️', rarity: 'epic', slot: 'armor', def: 18, hp: 90, classes: ['archer'], value: 800, desc: 'Bénie par les prêtres.', element: 'light', maxDurability: 1000, setId: 'light_set', reqLevel: 15 },
  light_robe: { id: 'light_robe', name: 'Aube radiante', icon: '🥻', rarity: 'epic', slot: 'armor', def: 18, hp: 90, classes: ['mage', 'healer'], value: 800, desc: 'Bénie par les prêtres.', element: 'light', maxDurability: 1000, setId: 'light_set', reqLevel: 15 },
  shadow_plate: { id: 'shadow_plate', name: 'Cuirasse des Ombres', icon: '🖤', rarity: 'epic', slot: 'armor', def: 14, hp: 60, classes: ['warrior'], value: 650, desc: 'Imbriquée de magie noire.', element: 'dark', maxDurability: 1000, setId: 'dark_set', reqLevel: 15 },
  shadow_leather: { id: 'shadow_leather', name: 'Brigandine des Ombres', icon: '🖤', rarity: 'epic', slot: 'armor', def: 14, hp: 60, classes: ['archer'], value: 650, desc: 'Imbriquée de magie noire.', element: 'dark', maxDurability: 1000, setId: 'dark_set', reqLevel: 15 },
  cultist_robe: { id: 'cultist_robe', name: 'Robe de Cultiste', icon: '🧥', rarity: 'epic', slot: 'armor', def: 14, hp: 60, classes: ['mage', 'healer'], value: 650, desc: 'Imbriquée de magie noire.', element: 'dark', maxDurability: 1000, setId: 'dark_set', reqLevel: 15 },
  obsidian_armor: { id: 'obsidian_armor', name: 'Armure d\'Obsidienne', icon: '⬛', rarity: 'epic', slot: 'armor', def: 24, hp: 110, classes: ['warrior'], value: 1000, desc: 'Presque impénétrable.', element: 'earth', maxDurability: 1000, setId: 'obsidian_set', reqLevel: 15 },
  obsidian_leather: { id: 'obsidian_leather', name: 'Harnais d\'Obsidienne', icon: '⬛', rarity: 'epic', slot: 'armor', def: 24, hp: 110, classes: ['archer'], value: 1000, desc: 'Presque impénétrable.', element: 'earth', maxDurability: 1000, setId: 'obsidian_set', reqLevel: 15 },
  obsidian_robe: { id: 'obsidian_robe', name: 'Mante d\'Obsidienne', icon: '🥻', rarity: 'epic', slot: 'armor', def: 24, hp: 110, classes: ['mage', 'healer'], value: 1000, desc: 'Presque impénétrable.', element: 'earth', maxDurability: 1000, setId: 'obsidian_set', reqLevel: 15 },
  ...
  sunplate_armor: { id: 'sunplate_armor', name: 'Cuirasse solaire', icon: '🌞', rarity: 'rare', slot: 'armor', def: 11, hp: 40, classes: ['warrior'], maxDurability: 550, value: 340, desc: 'Forgée dans le sable durci du désert.', reqLevel: 10 },
  sunplate_leather: { id: 'sunplate_leather', name: 'Tunique solaire', icon: '🌞', rarity: 'rare', slot: 'armor', def: 11, hp: 40, classes: ['archer'], maxDurability: 550, value: 340, desc: 'Forgée dans le sable durci du désert.', reqLevel: 10 },
