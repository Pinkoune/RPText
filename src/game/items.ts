...
export const ITEMS: Record<string, ItemDef> = {
  ...
  ember_axe: { id: 'ember_axe', name: 'Hache ardente', icon: '🪓', rarity: 'epic', slot: 'weapon', atk: 22, classes: ['warrior'], value: 500, desc: 'Brûle tout sur son passage.', element: 'fire', dmgType: 'physical', maxDurability: 500, setId: 'fire_set', reqLevel: 15 },
  ...
  earth_hammer: { id: 'earth_hammer', name: 'Marteau sismique', icon: '🔨', rarity: 'epic', slot: 'weapon', atk: 24, classes: ['warrior'], value: 600, desc: 'Fait trembler la terre.', element: 'earth', dmgType: 'physical', maxDurability: 500, setId: 'earth_set', reqLevel: 15 },
  ...
  sun_blade: { id: 'sun_blade', name: 'Lame Solaire', icon: '🗡️', rarity: 'epic', slot: 'weapon', atk: 22, classes: ['warrior'], value: 850, desc: 'Rayonne d\'une lumière intense.', element: 'light', dmgType: 'physical', maxDurability: 500, setId: 'light_set', reqLevel: 15 },
  shadow_bow: { id: 'shadow_bow', name: 'Arc des Ombres', icon: '🏹', rarity: 'legendary', slot: 'weapon', atk: 30, classes: ['archer'], value: 1800, desc: 'Tire des flèches invisibles.', element: 'dark', dmgType: 'physical', maxDurability: 500, setId: 'dark_set', reqLevel: 20 },
  obsidian_blade: { id: 'obsidian_blade', name: 'Lame d\'Obsidienne', icon: '🗡️', rarity: 'epic', slot: 'weapon', atk: 23, classes: ['warrior'], value: 700, desc: 'Tranchant terrifiant, très lourde.', element: 'earth', dmgType: 'physical', maxDurability: 500, setId: 'obsidian_set', reqLevel: 15 },
  ...
  frost_scepter: { id: 'frost_scepter', name: 'Sceptre de givre', icon: '🔱', rarity: 'rare', slot: 'weapon', atk: 14, classes: ['mage'], value: 230, desc: 'Le froid obéit à son porteur.', element: 'frost', dmgType: 'magical', maxDurability: 500, setId: 'frost_set', reqLevel: 10 },
  wind_staff: { id: 'wind_staff', name: 'Bâton du Vent', icon: '🌪️', rarity: 'rare', slot: 'weapon', atk: 12, classes: ['mage'], value: 210, desc: 'Invoque des rafales coupantes.', element: 'wind', dmgType: 'magical', maxDurability: 500, setId: 'wind_set', reqLevel: 10 },
  water_wand: { id: 'water_wand', name: 'Baguette Océanique', icon: '💧', rarity: 'rare', slot: 'weapon', atk: 13, classes: ['healer'], value: 280, desc: 'Purifie et frappe avec l\'eau.', element: 'water', dmgType: 'magical', maxDurability: 500, setId: 'water_set', reqLevel: 10 },
  ...
  earth_tome: { id: 'earth_tome', name: 'Grimoire Terrestre', icon: '📖', rarity: 'epic', slot: 'weapon', atk: 18, classes: ['mage'], value: 580, desc: 'Ses pages sont faites d\'écorce de fer.', element: 'earth', dmgType: 'magical', maxDurability: 500, setId: 'earth_set', reqLevel: 15 },
  ember_staff: { id: 'ember_staff', name: 'Bâton Ardent', icon: '🔥', rarity: 'epic', slot: 'weapon', atk: 21, classes: ['mage'], value: 650, desc: 'Canalise les feux de l\'enfer.', element: 'fire', dmgType: 'magical', maxDurability: 500, setId: 'fire_set', reqLevel: 15 },
  radiant_staff: { id: 'radiant_staff', name: 'Bâton Radiant', icon: '✨', rarity: 'epic', slot: 'weapon', atk: 22, classes: ['healer'], value: 900, desc: 'Illumine les ténèbres.', element: 'light', dmgType: 'magical', maxDurability: 500, setId: 'light_set', reqLevel: 15 },
  ...
  void_tome: { id: 'void_tome', name: 'Tome du Vide', icon: '📓', rarity: 'legendary', slot: 'weapon', atk: 32, classes: ['mage'], value: 2000, desc: 'Dévore l\'âme de celui qui le lit.', element: 'dark', dmgType: 'magical', maxDurability: 500, setId: 'dark_set', reqLevel: 20 },
  ...
  wind_cloak: { id: 'wind_cloak', name: 'Cape des vents', icon: '🌪️', rarity: 'rare', slot: 'armor', def: 9, hp: 35, classes: ['mage', 'healer'], value: 220, desc: 'Allège son porteur.', element: 'wind', maxDurability: 1000, setId: 'wind_set', reqLevel: 10 },
  scale_mail: { id: 'scale_mail', name: 'Cotte d\'écailles', icon: '🧜', rarity: 'rare', slot: 'armor', def: 10, hp: 40, classes: ['warrior', 'archer'], value: 250, desc: 'Écailles miroitantes.', element: 'water', maxDurability: 1000, setId: 'water_set', reqLevel: 10 },
