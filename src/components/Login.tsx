  ...
  return (
    <div className="grid h-full place-items-center bg-gradient-to-b from-[#0b1020] via-[#101a36] to-[#1a2b52] px-6">
      <div className="glass w-full max-w-md rounded-2xl p-8 text-center animate-floatIn">
        ...
        <button
          onClick={signIn}
          className="mt-7 flex w-full items-center justify-center gap-3 rounded-xl bg-white px-4 py-3 font-medium text-slate-800 transition hover:bg-slate-100 active:scale-[0.98]"
        >
