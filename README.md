...
- **Combat** au tour par tour (`hunt`, cooldown 90s façon EPIC RPG), montée de niveau, équipement, inventaire, boutique.
...
- **Récolte de ressources** (à la FFXIV) : bûcheronnage, minage, pêche, cueillette selon le biome (bois, pierre, fer, mithril, cristal, poisson, herbes…), sur cooldown. **Niveaux de métier** : monter un métier débloque les ressources rares et augmente le rendement.
...
- **Gambling — le « Casino du Destin »** : pile/face, dés, machine à sous, et une **roue liée au cycle jour/nuit** (segments x10 la nuit). Monnaie premium « Fate Coins ».
- **Multijoueur** :
  - **Duels PvP** au pile/face avec mise en or (le gagnant rafle tout).
  - **Boss mondial** partagé : tous les joueurs en ligne l'attaquent ensemble, butin partagé au prorata des dégâts.
...
| `profile` | profil, p | Carte de profil (stats, équipement) |
| `map` | carte, m | Voyage entre biomes |
| `inventory` | inv, sac | Inventaire : équiper / utiliser / vendre |
