...
export const MONSTERS: MonsterDef[] = [
  ...
  { id: 'storm_harpy', name: 'Harpie d\'orage', hp: 1150, atk: 132, def: 26, xp: 640, gold: [380, 650], biomes: ['skyreach'], loot: { storm_core: 0.45, sky_iron: 0.2, hi_potion: 0.2, repair_kit: 0.05 }, emoji: '🦅', element: 'wind', dmgType: 'physical', weaknesses: ['magical'] },
  { id: 'thunder_djinn', name: 'Djinn de foudre', hp: 1380, atk: 124, def: 38, xp: 700, gold: [400, 700], biomes: ['skyreach'], loot: { storm_core: 0.55, zephyr_bloom: 0.25, upgrade_matrix: 0.03 }, emoji: '🌀', element: 'wind', dmgType: 'magical', resistances: ['magical'], weaknesses: ['physical'] },
  { id: 'sky_leviathan', name: 'Léviathan des cimes', hp: 1380, atk: 113, def: 46, xp: 730, gold: [420, 720], biomes: ['skyreach'], loot: { sky_iron: 0.6, storm_core: 0.2, repair_kit: 0.05 }, emoji: '🐋', element: 'wind', dmgType: 'physical', resistances: ['physical'], weaknesses: ['magical'] },
  { id: 'lightning_seraph', name: 'Séraphin de foudre', hp: 1288, atk: 134, def: 32, xp: 760, gold: [450, 760], biomes: ['skyreach'], phases: ['dawn', 'day'], loot: { zephyr_bloom: 0.5, storm_core: 0.3, phoenix_feather: 0.015 }, emoji: '😇', element: 'light', dmgType: 'magical', resistances: ['magical'], weaknesses: ['physical'] },
  { id: 'tempest_sovereign', name: 'Souverain de la Tempête', hp: 1472, atk: 130, def: 50, xp: 1200, gold: [900, 1500], biomes: ['skyreach'], loot: { boss_soul: 0.02, storm_core: 0.9, sky_iron: 0.6, upgrade_matrix: 0.06 }, emoji: '⛈️', element: 'wind', dmgType: 'physical', resistances: ['physical'], weaknesses: [] },
  ...
  { id: 'dawn_watcher', name: 'Veilleur de l\'Aube', hp: 1426, atk: 136, def: 36, xp: 820, gold: [600, 1000], biomes: ['cradle'], loot: { dawn_shard: 0.5, origin_ash: 0.25, hi_potion: 0.25 }, emoji: '👁️', element: 'light', dmgType: 'magical', resistances: ['magical'], weaknesses: ['physical'] },
  { id: 'origin_golem', name: 'Golem d\'Origine', hp: 1564, atk: 120, def: 50, xp: 890, gold: [640, 1050], biomes: ['cradle'], loot: { dawn_shard: 0.7, sky_iron: 0.3, upgrade_matrix: 0.05 }, emoji: '🗿', element: 'light', dmgType: 'physical', resistances: ['physical'], weaknesses: ['magical'] },
  { id: 'the_unmade', name: 'L\'Informe', hp: 1472, atk: 141, def: 33, xp: 920, gold: [680, 1100], biomes: ['cradle'], loot: { origin_ash: 0.6, void_dust: 0.3, upgrade_matrix: 0.04 }, emoji: '🫧', element: 'neutral', dmgType: 'magical', weaknesses: ['physical'] },
  { id: 'first_flame', name: 'Première Flamme', hp: 1380, atk: 139, def: 40, xp: 940, gold: [700, 1150], biomes: ['cradle'], phases: ['dusk', 'night'], loot: { origin_ash: 0.45, world_seed: 0.06, phoenix_feather: 0.02 }, emoji: '🔥', element: 'light', dmgType: 'magical', resistances: ['magical'], weaknesses: ['physical'] },
  { id: 'world_warden', name: 'Gardien du Berceau', hp: 1748, atk: 135, def: 54, xp: 1430, gold: [1600, 2600], biomes: ['cradle'], loot: { boss_soul: 0.03, world_seed: 0.35, dawn_shard: 0.9, origin_ash: 0.7, upgrade_matrix: 0.08 }, emoji: '🕯️', element: 'dark', dmgType: 'physical', resistances: ['physical'], weaknesses: [] },
];
