...
export const MONSTERS: MonsterDef[] = [
  ...
  // ── Montagnes ──
  { id: 'yeti', name: 'Yéti', hp: 220, atk: 35, def: 12, xp: 90, gold: [30, 60], biomes: ['mountains', 'frozen'], loot: { frost_shard: 0.4, frost_glaive: 0.05, hi_potion: 0.08 }, emoji: '🦣' },
  ...
  // ── Désert ──
  { id: 'scorpion', name: 'Scorpion géant', hp: 260, atk: 42, def: 14, xp: 130, gold: [40, 80], biomes: ['desert'], loot: { ember_core: 0.35, frost_plate: 0.04, hi_potion: 0.1 }, emoji: '🦂' },
