...
export const MONSTERS: MonsterDef[] = [
  ...
  // ── Plaines ──
  { id: 'boar', name: 'Sanglier furieux', hp: 110, atk: 22, def: 5, xp: 35, gold: [10, 22], biomes: ['plains'], loot: { boar_tusk: 0.45, iron_blade: 0.04, potion: 0.1 , repair_kit: 0.05 , upgrade_matrix: 0.02 }, emoji: '🐗', element: 'earth', dmgType: 'physical', resistances: ['magical'] },
  { id: 'bandit', name: 'Bandit de grand chemin', hp: 130, atk: 26, def: 6, xp: 42, gold: [18, 40], biomes: ['plains'], phases: ['day', 'dusk'], loot: { iron_mail: 0.06, lucky_coin: 0.02, hi_potion: 0.05 , repair_kit: 0.05 , upgrade_matrix: 0.02 }, emoji: '🗡️', element: 'neutral', dmgType: 'physical' },
  { id: 'water_elemental', name: 'Élémentaire d\'eau', hp: 160, atk: 30, def: 10, xp: 60, gold: [20, 45], biomes: ['plains'], loot: { pure_water: 0.5, fish: 0.5 , repair_kit: 0.05 , upgrade_matrix: 0.02 }, emoji: '💧', element: 'water', dmgType: 'magical', weaknesses: ['magical'], resistances: ['physical'] },

  // ── Montagnes ──
  { id: 'yeti', name: 'Yéti', hp: 220, atk: 35, def: 12, xp: 90, gold: [30, 60], biomes: ['mountains'], loot: { frost_shard: 0.4, hi_potion: 0.08 , repair_kit: 0.05 , upgrade_matrix: 0.02 }, emoji: '🦣', element: 'frost', dmgType: 'physical', weaknesses: ['magical'] },
  { id: 'wraith', name: 'Spectre des cimes', hp: 180, atk: 45, def: 8, xp: 110, gold: [25, 55], biomes: ['mountains'], phases: ['night'], loot: { frost_shard: 0.5, void_dust: 0.1 , repair_kit: 0.05 , upgrade_matrix: 0.02 }, emoji: '👻', element: 'dark', dmgType: 'magical', weaknesses: ['magical'], resistances: ['physical'] },
  { id: 'golem', name: 'Golem de pierre', hp: 350, atk: 25, def: 20, xp: 120, gold: [35, 70], biomes: ['mountains'], loot: { stone: 0.8, iron_ore: 0.5, iron_ingot: 0.1 , repair_kit: 0.05 , upgrade_matrix: 0.02 }, emoji: '🪨', element: 'earth', dmgType: 'physical', resistances: ['physical'], weaknesses: ['magical'] },

  // ── Désert ──
  { id: 'scorpion', name: 'Scorpion géant', hp: 260, atk: 42, def: 14, xp: 130, gold: [40, 80], biomes: ['desert'], loot: { ember_core: 0.35, hi_potion: 0.1 , repair_kit: 0.05 , upgrade_matrix: 0.02 }, emoji: '🦂', element: 'earth', dmgType: 'physical', resistances: ['magical'] },
  { id: 'efreet', name: 'Éfrit', hp: 330, atk: 55, def: 16, xp: 200, gold: [60, 120], biomes: ['desert'], phases: ['day', 'dusk'], loot: { ember_core: 0.5, ember_axe: 0.04 , repair_kit: 0.05 , upgrade_matrix: 0.02 }, emoji: '🔥', element: 'fire', dmgType: 'magical', weaknesses: ['physical'] },
  { id: 'sun_priest', name: 'Prêtre du Soleil', hp: 280, atk: 60, def: 10, xp: 180, gold: [50, 100], biomes: ['desert'], phases: ['day'], loot: { sun_orb: 0.4, sun_shard: 0.3 , repair_kit: 0.05 , upgrade_matrix: 0.02 }, emoji: '📿', element: 'light', dmgType: 'magical', weaknesses: ['physical'], resistances: ['magical'] },

  // ── Marais ──
  { id: 'hydra', name: 'Hydre des marais', hp: 450, atk: 65, def: 20, xp: 280, gold: [80, 160], biomes: ['swamp'], loot: { void_dust: 0.3, gambler_ring: 0.03, hi_potion: 0.15 , repair_kit: 0.05 , upgrade_matrix: 0.02 }, emoji: '🐉', element: 'water', dmgType: 'physical' },
  { id: 'troll_shaman', name: 'Sorcier Troll', hp: 380, atk: 75, def: 15, xp: 250, gold: [70, 140], biomes: ['swamp'], phases: ['night'], loot: { voodoo_charm: 0.35, bog_root: 0.5 , repair_kit: 0.05 , upgrade_matrix: 0.02 }, emoji: '👹', element: 'dark', dmgType: 'magical', weaknesses: ['physical'], resistances: ['magical'] },
  ...
  { id: 'lava_titan', name: 'Titan de lave', hp: 1400, atk: 100, def: 40, xp: 600, gold: [280, 520], biomes: ['volcano'], loot: { boss_soul: 0.08, lava_crystal: 0.9, infernal_shard: 0.4, upgrade_matrix: 0.05 }, emoji: '🌋', element: 'fire', dmgType: 'physical', resistances: ['physical', 'magical'], weaknesses: [] },
  ...
  { id: 'crypt_warden', name: 'Gardien de la Crypte', hp: 2000, atk: 130, def: 55, xp: 800, gold: [350, 600], biomes: ['crypt'], loot: { boss_soul: 0.06, wraith_essence: 0.6, crypt_shard: 0.9, upgrade_matrix: 0.05 }, emoji: '🪦', element: 'dark', dmgType: 'physical', resistances: ['physical', 'magical'], weaknesses: [] },

  // ── Abysses du Vide (frozen) ──
  { id: 'voidling', name: 'Rejeton du vide', hp: 1300, atk: 140, def: 40, xp: 650, gold: [200, 380], biomes: ['frozen'], loot: { void_dust: 0.6, void_reaver: 0.03, hi_potion: 0.2 , repair_kit: 0.05 , upgrade_matrix: 0.02 }, emoji: '🕳️', element: 'dark', dmgType: 'magical', resistances: ['magical'], weaknesses: ['physical'] },
